...
///Creates a [Text] with Blinc style
///
///BlincText receives the [String] to be displayed and has some pre defined styles.
///For example:
/// ```dart
///BlincText("Example").weightRegular.heightSM.sizeMD;
/// ```
